<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DetalleUsuario.aspx.vb" Inherits="SARTI_FV2._0.DetalleUsuario" %>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
   ...
   <a href="Default.aspx">
      ...
      <i class="fas fa-power-off"></i>
        ...
        <H2 class="texto">Detalle de usuario </H2><small class="text-muted"><h4></h4> </small> 
    </div><br>
            
            <div class="row">
            
                <div class="col-lg-4"><b class="texto">Nombre:</b> Alan Enrique Medrano Maldonado<br></div>
                <div class="col-lg-4"><b class="texto">Departamento:</b> Sistemas<br></div>
                <div class="col-lg-4"><b class="texto">Correo:</b> alan.medrano@vigia.com.mx<br></div>
            
            </div><br>
             <div class="row">
            
                <div class="col-lg-4"><b class="texto">Puesto:</b> Jefazo</div>
                <div class="col-lg-4"> <b class="texto">Empresa:</b> SAVSA</div>
                <div class="col-lg-4"><b class="texto">Ubicacion:</b> Oficinas UU<br></div>
            
            </div><br>
            <p><b class="texto">Link de ubicación</b> www.google.com/maps<br> </p>           
            <br><br>
            <H2 class="texto"> </H2><small class="text-muted"><h5>Equipo(s) asignado(s):</h5> </small> <br>
                <table class="table table-striped">
    <thead>
      <tr class="texto">
               
        <th>Equipo</th>
        <th>Enviar a stock</th>  
        <th>ID Equipo</th>
