<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AsignarEquipo_Step1.aspx.vb" Inherits="SARTI_FV2._0.AsignarEquipo_Step1" %>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
   ...
   <a href="Default.aspx">
      ...
      <i class="fas fa-power-off"></i>
        ...
        <H2 class="texto">Busca y selecciona el usuario al que se le asiganara un nuevo equipo.</H2>
    </div>
           <br><br><br>
           <form action="AsignarEquipo_Step1.aspx" method="post" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                <input class="form-control" placeholder="soporte@vigia.com.mx" name="correo" type="email"><br />
                </div>
                <div class="col-lg-6">
                <button class="btn btn-outline-primary" >Buscar</button><br />
                </div>
            </div><br>  <br><br>

               <asp:Panel ID="pnl_tabla" runat="server" Visible="False" CssClass="">

                   <div class="table-responsive">
                   
                       <asp:GridView ID="tableusers" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EnableModelValidation="True">
                           <Columns>
                               <asp:HyperLinkField DataNavigateUrlFields="Link" DataTextField="Nombre" HeaderText="Usuario" Target="_blank" />
               ...
               <asp:Panel ID="pnl_Nodata" runat="server" Visible="False" Width="1007px">
                   <div class="alert alert-primary" role="alert">
                    Al parecer no hay usuarios acorde a la busqueda ingresada intenta nuevamente.
                </div>
