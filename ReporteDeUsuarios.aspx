<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteDeUsuarios.aspx.vb" Inherits="SARTI_FV2._0.ReporteDeUsuarios" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Vigia | SARTI</title>
        ...
        function FiltraTabla() {
            ...
            table = document.getElementById("dgv_empleados");
      ...
      <i class="fas fa-power-off"></i>
        ...
        <H2 class="texto">Empleados </H2>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                <input class="form-control" id="nombre" onkeyup="FiltraTabla()" ><br />
                </div>
               <div class="col-lg-5">
            ...
            <p class="texto">
                <b>Total de Empleados: </b><asp:Label ID="lbl_UsuariosCont" runat="server" Text="---"></asp:Label>

            </p>
            <div class="table-responsive texto">
            <asp:GridView CssClass="table table-striped table-bordered table-hover" ID="dgv_empleados" runat="server" Visible="true" AutoGenerateColumns="False" EnableModelValidation="True">
                <Columns>
                    <asp:HyperLinkField DataNavigateUrlFields="Link" DataTextField="Nombre" HeaderText="Nombre" />
                    <asp:BoundField DataField="Correo" HeaderText="Correo" />
                    <asp:BoundField DataField="IdUsuario" HeaderText="N° Empleado" />
                </Columns>
            </asp:GridView>
