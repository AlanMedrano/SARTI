<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteDeEquipos.aspx.vb" Inherits="SARTI_FV2._0.ReporteDeEquipos" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Vigia | SARTI</title>
        ...
        function FiltraTabla() {
            ...
            input = document.getElementById("Nserie");
            filter = input.value.toUpperCase();
            table = document.getElementById("dgv_ReporteEquipos");
  ...
  <div class="collapse navbar-collapse" id="navbarText">
   ...
   <a href="Default.aspx">
    ...
    <div class="container"><br><br>
        ...
        <H2 class="texto">Reporte de equipos </H2>
    </div><br>          
          <div class="row">
                <div class="col-lg-2"><br>
                  <b class="texto">Buscar por N° de serie:</b>
                </div>
                <div class="col-lg-4"><br>
                <input class="form-control" id="Nserie" onkeyup="FiltraTabla()">
                </div>
        ...
        <form runat="server">
            <asp:Panel ID="pnl_equipos" runat="server"></asp:Panel>
         <div class="table-responsive">
        <asp:GridView ID="dgv_ReporteEquipos" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover texto" EnableModelValidation="True">
            <Columns>
                <asp:HyperLinkField DataTextField="modelo" HeaderText="Modelo" DataNavigateUrlFields="LINK" />
            ...
            <asp:Panel ID="pnl_NoEquipos" runat="server">
               <div class="alert alert-primary" role="alert">
                    Al parecer no hay equipos dados de alta.
                </div>
            </asp:Panel>
         </form>
