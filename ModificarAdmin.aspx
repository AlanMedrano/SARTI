<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ModificarAdmin.aspx.vb" Inherits="SARTI_FV2._0.ModificarAdmin" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Vigia | SARTI</title>
        ...
        function FiltraTabla() {
            ...
            table = document.getElementById("dgv_administrador");
  ...
  <div class="collapse navbar-collapse" id="navbarText">
   ...
   <a href="Default.aspx">
      ...
      <i class="fas fa-power-off"></i>
        ...
        <H2 class="texto">Usuario Administrador.  </H2>
    </div><br/>
             <div class="row">
                <div class="col-lg-2">
            ...
            <asp:GridView ID="dgv_administrador" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" CssClass="table table-striped table-bordered table-hover" >
                <Columns>
                    <asp:HyperLinkField DataNavigateUrlFields="link" DataTextField="Administrador" HeaderText="Administrador" />
