<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DesenlazarEquipo.aspx.vb" Inherits="SARTI_FV2._0.DesenlazarEquipo" %>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
   ...
   <a href="Default.aspx">
    ...
    <div class="container"><br />
        ...
        <form runat="server">    
        <asp:Panel ID="pnl_tablaEmpleados" runat="server">
                              <div class="table-responsive">
                   
                       <asp:GridView ID="dgv_empleados" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" EnableModelValidation="True">
                           <Columns>
                               <asp:HyperLinkField DataNavigateUrlFields="Link" DataTextField="Empleado" HeaderText="Empleado" />
        ...
        <asp:Panel ID="pnl_NoEmpleados" runat="server">
                                   <div class="alert alert-primary" role="alert">
                    Al parecer no hay empleados registrados.
                </div>
        </asp:Panel>
</form>
        </div>
