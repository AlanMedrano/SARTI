   ...
   <a href="Default.aspx">
    ...
    <div class="container"><br/>
        <form runat="server">
            ...
            <asp:Panel ID="pnlModEmp" runat="server" Visible="false">
            ...
            <div class="collapse" id="collapseExample">
                <div class="card card-body">
                    <div id="pnl_UpdateEmpleado">
                        <div class="row texto">
                            <div class="col-lg-6">
                                <p>Nombre: </p> <input class="form-control" placeholder="" name="nombre" type="text" >
                            </div>
                            <div class="col-lg-6">
                                <p>Correo: </p> <input class="form-control" type="email" name="correo" >
                            </div>            
                        </div><br>            
                        <div class="row texto">
                            <div class="col-lg-6">
                        ...
                        <button class="btn btn-outline-primary" type="submit">Modificar empleado</button>                        
                        <br><br>
                    </div>
                </div>
             </div><br /><br />
